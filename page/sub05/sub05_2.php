...
if (G5_IS_MOBILE) {
    include_once(G5_MOBILE_PATH.'/page/sub05/sub05_2.php');
...
<div class="width-fixed">
	<div id="sub_left">
		<h2>고객지원</h2>
		<h3 class="mobile_menu" style="letter-spacing:-0.1em;padding:0 10px 0 0;">사이버감사팀</h3>
		<ul>
			<li style="letter-spacing:-0.1em;"><a href="<?php echo G5_URL; ?>/page/sub05/sub05_1.php">고객지원센터</a></li>
			<li class="active" style="letter-spacing:-0.1em;"><a href="<?php echo G5_URL; ?>/page/sub05/sub05_2.php">사이버감사팀</a></li>
			<li><a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=faq">고객 FAQ</a></li>
	...
	<div id="sub_right">
		<div id="sub_title">
			<p>
				...
				<a href="<?php echo G5_URL."/page/sub05/sub05_1.php"; ?>">고객지원</a> &gt; 
				<a href="<?php echo G5_URL; ?>/page/sub05/sub05_2.php" class="red">사이버감사팀</a>
			</p>
			<h2 style="letter-spacing:-0.1em;">사이버감사팀</h2>
		</div>
		<div class="inquiry">
			<div class="inquiry_top">
				<h2>이용안내</h2>
				<p style="letter-spacing:-0.07em;">(주)한양종합건설은 부정부패없는 깨끗한 기업문화를 위해 사이버 감사팀을 운영하고 있습니다.<br />제보하신 내용은 사실여부를 확인하여 투명하고 공정하게 처리할 것이며, 제보자의 신원은 철저한 비밀을 보장합니다.</p>
			</div>
			<div class="inquiry_con">
				<h2>제보하기</h2>
				<form action="<?php echo G5_URL."/page/sub05/sub05_2_update.php"; ?>" method="post" id="r_form" name="r_form" onsubmit="return r_form_submit(this);" enctype="multipart/form-data">
					<div class="inquiry_form">
						<div class="grid_100 bdb">
							<div class="th grid_20 pr0 p_grid_30 pm_grid_100">이름</div>
							<div class="td grid_80 p_grid_70 pm_grid_100"><input type="text" name="name" id="name" class="input_01 grid_100" required /></div>
						</div>
						<div class="grid_100 bdb">
							<div class="th grid_20 pr0 p_grid_30 pm_grid_100">생년월일</div>
							<div class="td grid_80 p_grid_70 pm_grid_100"><input type="text" name="birth" id="birth" class="input_01 grid_30 t_grid_50 p_grid_100" required /></div>
						</div>
						<div class="grid_100 bdb">
						...
						<div class="grid_100 bdb">
							<div class="th grid_20 pr0 p_grid_30 pm_grid_100">연락처</div>
							<div class="td grid_80 p_grid_70 pm_grid_100">
