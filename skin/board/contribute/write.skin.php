			...
			<div class="table_03">
				<table class="text-left">
					...
					<tr>
						...
						<td><input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" required class="input_01 grid_30" size="10" maxlength="20"></td>
					</tr>
					<?php } ?>
					<?php if ($is_password) { ?>
					<tr>
						<th scope="row"><label for="wr_password">비밀번호<strong class="sound_only">필수</strong></label></th>
						<td><input type="password" name="wr_password" id="wr_password" <?php echo $password_required ?> class="input_01 grid_30" maxlength="20"></td>
					</tr>
					<?php } ?>
					<?php if ($is_email) { ?>
					<tr>
						<th scope="row"><label for="wr_email">이메일</label></th>
						<td><input type="text" name="wr_email" value="<?php echo $email ?>" id="wr_email" class="input_01 grid_30 email" size="50" maxlength="100"></td>
					</tr>
					<?php } ?>
					<?php if ($is_homepage) { ?>
					<tr>
						<th scope="row"><label for="wr_homepage">홈페이지</label></th>
						<td><input type="text" name="wr_homepage" value="<?php echo $homepage ?>" id="wr_homepage" class="input_01 grid_30" size="50"></td>
					</tr>
					<?php } ?>
					<?php if ($option) { ?>
					<tr>
					...
					<tr>
						<th scope="row"><label for="wr_1">출처</label></th>
						<td><input type="text" name="wr_1" value="<?php echo $write['wr_1']; ?>" id="wr_1" class="input_01 grid_30 grid_70 p_grid_100 " size="50"></td>
					</tr>
					<tr>
						<th>내용</th>
						<td class="wr_content">
