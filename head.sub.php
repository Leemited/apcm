...
<head>
<meta charset="utf-8">
<link rel="shortcut icon" href="<?=G5_URL?>/img/logo.png" type="image/x-icon" />
<link rel="icon" href="<?=G5_URL?>/img/logo.png" type="image/x-icon" />
<?php
if (G5_IS_MOBILE) {
...
?>
<!-- <link rel="stylesheet" href="<?php echo G5_CSS_URL; ?>/owl.transitions.css" /> -->
...
<link type='text/css' rel='stylesheet' href='<?php echo G5_CSS_URL; ?>/demo.css' />
<link type='text/css' rel='stylesheet' href='<?php echo G5_CSS_URL; ?>/jquery.mmenu.all.css' />
...
<script type="text/javascript" src="<?php echo G5_JS_URL ?>/jquery.mmenu.min.all.js"></script>
<?php
if(G5_IS_MOBILE) {
